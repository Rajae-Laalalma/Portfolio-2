...
<h1 className='uppercase py-2'>I build things for web</h1>
      ...
      <div className='w-80 h-80 rounded-full mx-40 m-20 md:mx-8  '><img src={profile} alt=""  className=' md:w-80 md:h-80 h-60 w-60 rounded-full border-4 border-transparent bg-clip-border bg-gradient-to-r from-blue-500 to-violet-600 transform transition-transform duration-300 hover:scale-125 cursor-pointer '/></div>
