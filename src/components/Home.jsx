  ...
  return (
    ...
    <div id="Home" className='md:flex md:flex-row  justify-center items-center  w-full h-screen px-10 py-10  '>
      <div className='  text-4xl font-title font-bold text-blue-900 md:pr-40 dark:text-gray-300'>
        ...
        <button
  type="submit"
  className="w-32 h-10  rounded-2xl text-xl  bg-violet-700 md:text-xl text-white transition duration-300 ease-in-out hover:bg-blue-500 hover:scale-105 dark:text-gray-300"
>
  Portfolio
</button>
