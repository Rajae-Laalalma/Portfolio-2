...
<div className='md:py-4 py-8 '>
   <button className='text-xl  text-white bg-gradient-to-r from-blue-500 to-violet-500 w-32  h-11 rounded font-normal transform transition-transform duration-300 hover:scale-125'>Portfolio</button> 
      ...
      <div className='w-80 h-80 rounded-full mx-40 md:mx-8  '><img src={profile} alt=""  className=' w-80 h-80  rounded-full border-4 border-transparent bg-clip-border bg-gradient-to-r from-blue-500 to-violet-600  '/></div>
    </div>
  )
}
